  ...
  <body>
      ...
      <div class="middle">
          <span style="float:left;margin-left:10%;width:80%;height:60px;border-bottom:1px solid black;font-size:120%;color:red;line-height:80px;">
              <font style="float:left;">注册成功</font>
              <a href="${pageContext.request.contextPath}/person/user/regist?pageSource=${pageSource}"><span style="float:right;margin-top:10px;text-align:center;width:40px;height:40px;background:red;border-radius:50px;color:white;font-size:80%;line-height:40px;">返回</span></a>
          </span>
          <div class="middle_center">
              <span class="middle_1">
                  <span class="result_logo"><img src="./images/comm/true.jpg" width="100%" height="100%"/></span>
                  <span class="result_title"><font style="color:red;">恭喜您！</font>注册成功</span>
              </span>
              <span class="middle_2">
                  <span class="middle_2_text1">
                                                     您的新账号为:<font style="color:red;">${userNewId}</font>
                    <a class="b" href="${pageContext.request.contextPath}/person/user/login?pageSource=${page}" style="float:right;font-size:120%;">去登陆</a>
                  </span>
