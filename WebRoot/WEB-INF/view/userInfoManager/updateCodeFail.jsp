      ...
      <div class="middle">
          ...
          <div class="middle_center">
              <span class="middle_1">
                  ...
                  <span class="result_title"><font style="color:red;">抱歉！</font>密码修改失败</span>
              </span>
              <span class="middle_2">
                  <span class="middle_2_text1">
                    <font style="color:red;">您的账户安全系数很低，稍后重试</font>
                    <a class="b" href="${pageContext.request.contextPath}/person/user/findCode?pageSource=${pageSource}" style="float:right;font-size:120%;">继续找回密码</a>
                  </span>
